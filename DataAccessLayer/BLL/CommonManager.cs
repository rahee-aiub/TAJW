...
namespace DataAccessLayer.BLL
{
    public class CommonManager
    {
        ...
        public GridView FillGridViewListWithSP(string spName, object[] sparams, GridView gridList, string dbName)
        {
            _objDAO = new CommonDAO();
            return _objDAO.FillGridViewListWithSP(spName, sparams, gridList, dbName);
        }
        ...
        internal DataTable GetDataTableBySpWithParams(string p1, string p2)
        {
