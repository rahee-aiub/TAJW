...
namespace DataAccessLayer.DTO.CustomerServices
{
    ...
    public class A2ZTRNLOGICDTO
    {
        ...
        public static A2ZTRNLOGICDTO GetInterestAmt6YR(int BranchNo, Int16 MemType, int MemberNo, int AccType, Int64 AccountNo)
        {
            ...
            prm[3] = AccType;
            prm[4] = AccountNo;
            int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSCalculateEncashment6YR", prm, "A2ZACGMS"));
            if (result == 0)
            {
        ...
        public static A2ZTRNLOGICDTO GetInterestAdjCrPension(int BranchNo, Int16 MemType, int MemberNo, int AccType, Int64 AccountNo)
        {
            ...
            prm[3] = AccType;
            prm[4] = AccountNo;
            int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSCalculateEncashmentCPS", prm, "A2ZACGMS"));
            if (result == 0)
            {
