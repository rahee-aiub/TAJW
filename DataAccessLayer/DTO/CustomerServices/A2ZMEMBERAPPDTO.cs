...
namespace DataAccessLayer.DTO.CustomerServices
{
    public class A2ZMEMBERAPPDTO
    {
        ...
        public String MemTypeDesc { set; get; }
        public int MemApplicationNo { set; get; }
        public DateTime MemApplicationDate { set; get; }
        ...
        public String MemAppNullDate { set; get; }
        // 1= Record Found, 0=No Record Found

        public Int16 MemNoGuarantor { set; get; }

        public int UserId { set; get; }
        public Int16 MemProcFlag { set; get; }
        public Int16 MemModule { set; get; }

        #endregion

        public static int InsertInformation(A2ZMEMBERAPPDTO dto)
        {
            ...
            SqlParameter param8 = new SqlParameter("@MemApplicationDate", DBNull.Value);
        ...
        public static int Insert(A2ZMEMBERAPPDTO dto)
        {
        ...
        public static int Update(A2ZMEMBERAPPDTO dto)
        {
            dto.MemberName = (dto.MemberName != null) ? dto.MemberName.Trim().Replace("'", "''") : "";
            int rowEffect = 0;
        ...
        public static int Update2(A2ZMEMBERAPPDTO dto)
        {
        ...
        public static A2ZMEMBERAPPDTO GetInfoOldMember(int BranchNo, int MemNo)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_CSGetInfoOldMem", prm, "A2ZACGMS");
        ...
        public static A2ZMEMBERAPPDTO GetInformation(int BranchNo, int MemType, int MemNo)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_CSGetInfoMember", prm, "A2ZACGMS");
        ...
        public static A2ZMEMBERAPPDTO GetInformationMemNo(int BranchNo, int MemAppNo)
        {
            var prm = new object[2];
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_CSGetInfoMemberAppNo", prm, "A2ZACGMS");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                p.BranchNo = Converter.GetInteger(dt.Rows[0]["BranchNo"]);
                p.MemType = Converter.GetSmallInteger(dt.Rows[0]["MemType"]);
                p.MemTypeDesc = Converter.GetString(dt.Rows[0]["MemTypeDesc"]);
                p.MemApplicationNo = Converter.GetInteger(dt.Rows[0]["MemApplicationNo"]);
                p.MemApplicationDate = Converter.GetDateTime(dt.Rows[0]["MemApplicationDate"]);
                ...
                p.OldMemNo = Converter.GetInteger(dt.Rows[0]["MemOldMemNo"]);
                p.MemNoGuarantor = Converter.GetSmallInteger(dt.Rows[0]["MemNoGuarantor"]);
                p.MemProcFlag = Converter.GetSmallInteger(dt.Rows[0]["MemProcFlag"]);
                p.MemStatus = Converter.GetSmallInteger(dt.Rows[0]["MemStatus"]);
                p.MemModule = Converter.GetSmallInteger(dt.Rows[0]["MemModule"]);
        ...
        public static A2ZMEMBERAPPDTO GetOldInformation(Int16 CuType, int CUNo, int MemNo)
        {
        ...
        public static int UpdateInformation(A2ZMEMBERAPPDTO dto)
        {
            ...
            int result = Helper.SqlHelper.ExecuteNonQuery(DataAccessLayer.Constants.DBConstants.GetConnectionString("A2ZACGMS"), "Sp_CSMemberAppDataUpdate", new object[] { dto.ID, dto.UserId, dto.BranchNo, dto.MemType, dto.MemTypeDesc, dto.MemApplicationNo, param8, dto.MemberName, dto.FatherName, dto.MotherName, dto.SpouseName, dto.Occupation, dto.Nationality, dto.Gender, dto.Religion, dto.Nature, dto.MaritalStatus, param1, param2, dto.PlaceofBirth, dto.PreAddressLine1, dto.PreAddressLine2, dto.PreAddressLine3, dto.PreVillage, dto.PrePostOffice, dto.PreDivision, dto.PreDistrict, dto.preUpzila, dto.preThana, dto.PreTelephone, dto.PreMobile, dto.PreEmail, dto.PerAddressLine1, dto.PerAddressLine2, dto.PerAddressLine3, dto.PerVillage, dto.PerPostOffice, dto.PerDivision, dto.PerDistrict, dto.PerUpzila, dto.PerThana, dto.PerTelephone, dto.PerMobile, dto.PerEmail, dto.EmployerName, dto.EmployerAddress, dto.MemIntroMemType, dto.MemIntroMemNo, dto.IntroducerNo2, dto.IntroducerName2, dto.NationalIdNo, dto.PassportNo, param3, param4, dto.PassportIssuePlace, dto.TIN, param5, param6, dto.MemBloodGroup, dto.MemRegNo, dto.MemSubRegNo, dto.MemColCode, param7 });
