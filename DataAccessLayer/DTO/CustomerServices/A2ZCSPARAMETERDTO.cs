...
namespace DataAccessLayer.DTO.CustomerServices
{
    public class A2ZCSPARAMETERDTO
    {
        ...
        public int LastConfirmVoucherNo { set; get; }
        #endregion
        ...
        public static A2ZCSPARAMETERDTO GetParameterValue()
        {
            ...
            p.LastVoucherNo = Utility.Converter.GetInteger(dt.Rows[0]["LastVoucherNo"]);
            ...
            p.LastConfirmVoucherNo = Utility.Converter.GetInteger(dt.Rows[0]["LastConfirmVoucherNo"]);
        ...
        public static int UpdateConfirmVchNo(int lVch)
        {
            string sqlQuery = "UPDATE A2ZCSPARAMETER SET LastConfirmVoucherNo = " + lVch;
            return Converter.GetInteger(BLL.CommonManager.Instance.ExecuteNonQuery(sqlQuery, "A2ZACGMS"));
        }
