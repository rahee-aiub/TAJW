   ...
   public class A2ZACCTYPEDTO
    {
       ...
       public int AccSuretyGLCode { set; get; }
       #endregion
        ...
        public static A2ZACCTYPEDTO GetInformation(int Typecode)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_GetInfoAccType", prm, "A2ZACGMS");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                p.AccSuretyGLCode = Converter.GetInteger(dt.Rows[0]["AccSuretyGLCode"]);
        ...
        public static A2ZACCTYPEDTO GetOldInformation(int Typecode)
        {
            ...
            DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZACCTYPE WHERE OldAccType = " + Typecode, "A2ZACGMS");
        ...
        public static int UpdateInformation(A2ZACCTYPEDTO dto)
        {
            ...
            string strQuery = "UPDATE A2ZACCTYPE set AccTypeCode='" + dto.AccTypeCode + "',AccTypeDescription='" + dto.AccTypeDescription + "',AccTypeClass='" +
                ...
                dto.AccFineGLCode + "',AccClosingFeeGLCode='" + dto.AccClosingFeeGLCode + "',AccProcessFeeGLCode='" + dto.AccProcessFeeGLCode + "',AccDepositFeeGLCode='" + dto.AccDepositFeeGLCode + "',AccBonusGLCode='" + dto.AccBonusGLCode + "',AccSuretyGLCode='" + dto.AccSuretyGLCode + "',AccProvisionMode='" + 
