...
namespace DataAccessLayer.DTO.CustomerServices
{
   public class A2ZLOANDTO
   {
       ...
       public static A2ZLOANDTO GetInformation(int BranchNo,int AppNo)
       {
           ...
           DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_CSGetInfoLoan", prm, "A2ZACGMS");
       ...
       public static int UpdateInformationBySP(A2ZLOANDTO dto)
       {
           ...
           int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_CSLoanDataUpdate", prm, "A2ZACGMS"));
           if (result == 0)
           {
               rowEffect = 1;
           }
           ...
           //BLL.CommonManager.Instance.GetScalarValueBySp("Sp_CSLoanDataUpdate", prm, "A2ZACGMS");
