...
namespace DataAccessLayer.DTO.CustomerServices
{
   public class A2ZACCNOMINEEDTO
   {
       ...
       public static A2ZACCNOMINEEDTO GetInformation(int NomNo, int brno, int acctype, Int16 MemType, int MemNo, Int64 AccNo)
       {
           ...
           DataTable dt = BLL.CommonManager.Instance.GetDataTableBySpWithParams("Sp_CSGetInfoAccNominee", prm, "A2ZACGMS");
       ...
       {
           DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZACCNOM WHERE Id = '" + ID + "'", "A2ZACGMS");
       ...
       {
           DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM WFCSA2ZACCNOM WHERE Id = '" + ID + "'", "A2ZACGMS");
