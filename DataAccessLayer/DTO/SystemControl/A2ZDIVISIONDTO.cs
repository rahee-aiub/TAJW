...
namespace DataAccessLayer.DTO.SystemControl
{
   public class A2ZDIVISIONDTO
   {
       ...
       {
           DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZDIVISION WHERE DiviCode = " + DivCode, "A2ZHKGMS");
       ...
       {
           DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZDIVISION WHERE DiviOrgCode = " + DivCode, "A2ZHKGMS");
