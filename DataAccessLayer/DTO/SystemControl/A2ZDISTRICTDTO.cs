   ...
   public class A2ZDISTRICTDTO
    {
        ...
        {
            DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZDISTRICT WHERE DiviCode = '" + DivCode + "' and DistCode='" + DisCode + "'", "A2ZHKGMS");
        ...
        {
            DataTable dt = BLL.CommonManager.Instance.GetDataTableByQuery("SELECT * FROM A2ZDISTRICT WHERE DistOrgCode = '" + DisCode + "'", "A2ZHKGMS");
