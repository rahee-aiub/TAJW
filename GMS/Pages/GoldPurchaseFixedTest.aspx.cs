...
{
    public partial class GoldPurchaseFixedTest : System.Web.UI.Page
    {
        ...
        protected void BtnAddItem_Click(object sender, EventArgs e)
        {
            ...
            {
                txtRateUSD.Focus();
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Please Input Rate USD');", true);
                return;
            }
            ...
            try
            {
                ...
                prm[17] = "1"; //Fixed Record Type
                prm[18] = "Fixed Purchase";
                prm[19] = "1"; //Fixed/Unfixed       
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_InsertWfItemGold]", prm, "A2ZACGMS"));
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                CtrlVoucherNo.Text = "GPF" + getDTO.RecLastNo.ToString("000000");
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_InsertItemGold]", prm, "A2ZACGMS"));
