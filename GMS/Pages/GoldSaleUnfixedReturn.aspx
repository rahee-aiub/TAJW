<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldSaleUnfixedReturn.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldSaleUnFixedReturn" Title="Gold Sale - UnFixed Return" %>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <table class="style1">
                            <thead>
                                <tr>
                                    <th colspan="4">UnFixed - Gold Sale Return
                                    </th>
                                </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtPurity" runat="server" Width="50px" Height="25px" Style="text-align: Right" Font-Size="Small" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtPurity_TextChanged"></asp:TextBox>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtMakingRate" runat="server" Width="70px" Height="25px" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtMakingRate_TextChanged"></asp:TextBox>
                        </td>
                        <td>
                            <h6>
                            ...
                            <asp:TextBox ID="txtStoneMakingRate" runat="server" Width="70px" Height="25px" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtStoneMaking_TextChanged"></asp:TextBox>
                        </td>
                        <td>
                            <h6>
                            ...
                            <asp:TextBox ID="txtCarryingRate" runat="server" Width="70px" Height="25px" Enabled="false" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtCarryingRate_TextChanged"></asp:TextBox>
                        </td>
                        <td>
                            <h6>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtConvDiscount" runat="server" CssClass="cls text" Width="150px" Height="27px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Large" Style="text-align: Right" AutoPostBack="True" OnTextChanged="txtConvDiscount_TextChanged"></asp:TextBox>
                            </td>
