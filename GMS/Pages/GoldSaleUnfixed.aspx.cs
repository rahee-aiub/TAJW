...
{
    public partial class GoldSaleUnFixed : System.Web.UI.Page
    {
        ...
        protected void BtnAddItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                prm[17] = "22"; //Fixed Purchase Type
                prm[18] = "UnFixed Sale"; //Sale Type
        ...
        {
            lblStockPureWt.Text = (Converter.GetDecimal(txtNetWt.Text) * Converter.GetDecimal(lblStockPurity.Text)).ToString("0.00");
            lblStockMakingValue.Text = (Converter.GetDecimal(txtNetWt.Text) * Converter.GetDecimal(lblStockMakingRate.Text)).ToString("0.00");
            lblStockStoneMakingValue.Text = (Converter.GetDecimal(txtStoneWt.Text) * Converter.GetDecimal(lblStockStoneMakingRate.Text)).ToString("0.00");
            lblStockCarringValue.Text = (Converter.GetDecimal(txtGrossWt.Text) * Converter.GetDecimal(lblStockCarringRate.Text)).ToString("0.00"); ;
        }
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            ...
            CtrlVoucherNo.Text = "GSU" + getDTO.RecLastNo.ToString("000000");
        ...
        protected void btnViewEstimate_Click(object sender, EventArgs e)
        {
            try
            {
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO1, txtConvRate.Text);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.COMMON_NO2, txtFinalCarringRate.Text);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.USERNO, lblID.Text);
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_DATABASE_NAME_KEY, "A2ZACGMS");
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptGmsUnFixedSaleEstimate");
