...
{
    public partial class PurchaseFixingReturn : System.Web.UI.Page
    {
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_PurchaseFixingReturn]", prm, "A2ZACGMS"));
