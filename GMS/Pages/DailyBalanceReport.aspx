<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="DailyBalanceReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.DailyBalanceReport" Title="Daily Balance Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        ...
        <table class="style1" width="800px">
              <thead>
                <tr>
                    <th colspan="4">Daily Business Position
                    </th>
                </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label7" runat="server" Text="Balance Date :" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
