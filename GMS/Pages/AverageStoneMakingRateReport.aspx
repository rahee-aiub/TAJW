<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="AverageStoneMakingRateReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.AverageStoneMakingRateReport" Title="Average Currency Exchange Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        ...
        <table class="style1" width="800px">
            <thead>
                <tr>
                    <th colspan="6">Average Stone Making Rate Report
                    </th>
                </tr>
