<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldReceiveAndPaymentReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldReceiveAndPaymentReport" Title="Gold Receive And Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        ...
        <table class="style1" width="900px">
              <thead>
                <tr>
                    <th colspan="6">Gold Receive And Payment Report
                    </th>
                </tr>
