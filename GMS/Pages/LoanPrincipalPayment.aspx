<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="LoanPrincipalPayment.aspx.cs" Inherits="ATOZWEBGMS.Pages.LoanPrincipalPayment" Title="Principal Payment" %>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtPrincLoanAmount" runat="server" CssClass="cls text" Width="150px" Height="27px" Style="text-align: Right" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="6" autocomplete="off" AutoPostBack="true" OnTextChanged="txtPrincLoanAmount_TextChanged" onkeyup="javascript:this.value=Comma(this.value);"></asp:TextBox>
                      &nbsp; &nbsp; &nbsp; 
                </td>
