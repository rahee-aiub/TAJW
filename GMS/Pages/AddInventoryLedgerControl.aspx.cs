...
{
    public partial class AddInventoryLedgerControl : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    prm[3] = ddlCarryingLedger.SelectedValue;
                }
                ...
                {
                    prm[4] = ddlMakingLedger.SelectedValue;
                }
                ...
                {
                    prm[5] = ddlStoneLedger.SelectedValue;
                }
               

                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_InsertInventoryLdg]", prm, "A2ZACGMS"));
