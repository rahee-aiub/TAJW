<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="LoanAdjustmentPayment.aspx.cs" Inherits="ATOZWEBGMS.Pages.LoanAdjustmentPayment" Title="Loan Adjustment Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="4">Loan Adjustment Payment
                    </th>
                </tr>
        ...
        <table class="style1">
            ...
            <tr>
                <td>
                  ...
                  <td>
                       <asp:DropDownList ID="ddlTrnMode" runat="server" CssClass="cls text" Width="200px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                ...
                <td>
                    <asp:Label ID="Label13" runat="server" Text="Adjustment Mode :" Font-Size="Large" ForeColor="Red"></asp:Label>
                    &nbsp;
                      <asp:DropDownList ID="ddlAdjustmentMode" runat="server" CssClass="cls text" Width="200px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="5">
                        <asp:ListItem Value="0">-Select-</asp:ListItem>
          ...
          <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="Adjustment Loan Amount :" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtAdjustmentAmt" runat="server" CssClass="cls text" Width="150px" Height="27px" Style="text-align: Right" BorderColor="#1293D1" BorderStyle="Ridge"
