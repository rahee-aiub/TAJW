<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="CurrencyPurchase.aspx.cs" Inherits="ATOZWEBGMS.Pages.CurrencyPurchase" Title="Currency Purchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label3" runat="server" Text="Purchase Currency :" Width="170px" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td colspan="3">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="Purchase " Width="120px" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td colspan="3">
                    <table class="style1">
                        <tr align="center">
            ...
            <tr style="display:none">
              ...
              <tr>
                <td>
                    <asp:Label ID="Label11" runat="server" Text="Description " Font-Size="Large" ForeColor="Red" Width="120px"></asp:Label>
                </td>
                <td colspan="3">
