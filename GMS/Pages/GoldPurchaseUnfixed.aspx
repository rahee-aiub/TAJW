<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldPurchaseUnfixed.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldPurchaseUnfixed" Title="Gold Purchase - Unfixed" %>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <table class="style1">
                            <thead>
                                <tr>
                                    <th colspan="4">Un-Fix Gold Purchase
                                    </th>
                                </tr>
                    ...
                    <script type="text/javascript" src="../Script/chosen.jquery.js"></script>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:DropDownList ID="ddlCurrency" runat="server" CssClass="cls text" Width="120px" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
        ...
        <div align="center">
                ...
                <table class="style1">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtItemName" runat="server" TabIndex="1" Width="200px" Height="25px" Font-Size="Small"
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtGrossWt" runat="server" TabIndex="2" Width="70px" Height="25px" Style="text-align: Right" Font-Size="Small" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtGrossWt_TextChanged"></asp:TextBox>
                        </td>
                        <td>
                            <h6>
                                <asp:Label ID="Label13" runat="server" Text="Stone Wt" ForeColor="Red"></asp:Label></h6>
                            <asp:TextBox ID="txtStoneWt" runat="server" TabIndex="3" Width="70px" Height="25px" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" AutoPostBack="True" OnTextChanged="txtStoneWt_TextChanged"></asp:TextBox>
                        </td>
                        <td>
                            <h6>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtMakingValue" runat="server" Width="120px" Height="25px" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                onFocus="javascript:this.select()" CssClass="cls text" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td>
                            <h6>
                                <asp:Label ID="Label22" runat="server" Text="Stone Value" ForeColor="Red"></asp:Label></h6>
                            <asp:TextBox ID="txtStoneMakingValue" runat="server" Width="120px" Height="25px" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                CssClass="cls text" ReadOnly="True"></asp:TextBox>
                        </td>
                        <%--  <td>
                        <h6>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtTotalValue" runat="server" Width="120px" Height="25px" Font-Size="Small" Style="text-align: Right" onkeypress="return IsDecimalKey(event)"
                                CssClass="cls text" ReadOnly="True"></asp:TextBox>
                        </td>
                        ...
                        <td>
                            ...
                            <br />
                            <br />
                            <asp:Button ID="BtnAddItem" runat="server" TabIndex="6" Text="Add" Width="80px" Font-Size="Large"
            ...
            <div align="center">
                ...
                <table class="style1">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label17" runat="server" Text="Total:" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Red"></asp:Label>
                            Gross Wt: 
                    <asp:Label ID="lblGrossWt" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Blue"></asp:Label>
                            Stone Wt: 
                    <asp:Label ID="lblStoneWt" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Blue"></asp:Label>
                            Net Wt: 
                    <asp:Label ID="lblNetWt" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Blue"></asp:Label>
                            Pure Wt:
                    <asp:Label ID="lblPureWt" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Red"></asp:Label>
                            Making:
                    <asp:Label ID="lblMaking" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Blue"></asp:Label>
                            Stone:
                    <asp:Label ID="lblStoneValue" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Blue"></asp:Label>

                            <asp:Label ID="lblMetalValue" runat="server" Width="120px" Height="25px" Visible="false" Text="" Font-Bold="true" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                            Total:
                    <asp:Label ID="lblTotalValue" runat="server" Text="" Width="120px" Height="25px" Font-Size="Medium" Font-Bold="true" ForeColor="Red"></asp:Label>
                ...
                <td style="vertical-align: top;">
                    <table class="style1" style="width: 340px; height: 380px;">
                        <thead>
                            <tr>
                                <th colspan="4">
                                    <asp:Label ID="Label41" runat="server" Text="Unfixed - Gold Purchase" Font-Size="Large"
