<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldInventoryReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldInventoryReport" Title="Gold Inventory Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        ...
        <table class="style1" width="800px">
            <thead>
                <tr>
                    <th colspan="6">Gold Inventory Report
                    </th>
                </tr>
            ...
            <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtSaleAndReturn" runat="server" GroupName="RptOptPrm" Text="Gold Sale and Sales Return" Style="font-weight: 700" Font-Italic="True" />
