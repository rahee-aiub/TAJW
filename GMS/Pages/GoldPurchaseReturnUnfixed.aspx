<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldPurchaseReturnUnfixed.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldPurchaseReturnUnfixed" Title="Gold Purchase Return - Unfixed" %>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <table class="style1">
                            <thead>
                                <tr>
                                    <th colspan="4">Un-Fix Gold Purchase Return
                                    </th>
                                </tr>
                    ...
                    <script type="text/javascript" src="../Script/chosen.jquery.js"></script>
                        ...
                        <%--<h1>Gold Purchase Return - Unfixed</h1>--%>
                    </td>
                    <td style="vertical-align: top;">
                        <table class="style1">
                            <thead>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="ddlKarat" runat="server" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                                Width="70px" Font-Size="Small" AutoPostBack="True" OnSelectedIndexChanged="ddlKarat_SelectedIndexChanged" TabIndex="4">
                                <asp:ListItem Value="0">-Sel-</asp:ListItem>
                ...
                <td style="vertical-align: top;">
                    <table class="style1" style="width: 340px; height: 380px;">
                        <thead>
                            <tr>
                                <th colspan="4">
                                    <asp:Label ID="Label41" runat="server" Text="Unfixed - Purchase Return" Font-Size="Large"
