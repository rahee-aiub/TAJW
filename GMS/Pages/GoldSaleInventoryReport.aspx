<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldSaleInventoryReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldSaleInventoryReport" Title="Gold Sale Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        ...
        <table class="style1" width="800px">
            ...
            <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtSaleAndReturn" runat="server" GroupName="RptOptPrm" Text="Gold Sale and Sales Return" Style="font-weight: 700" Font-Italic="True" Checked="true" AutoPostBack="true" OnCheckedChanged="rbtSaleAndReturn_CheckedChanged" />

                </td>
            </tr>

            <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtSaleFixing" runat="server" GroupName="RptOptPrm" Text="Gold Sale Fixing" Style="font-weight: 700" Font-Italic="True" AutoPostBack="true" OnCheckedChanged="rbtSaleFixing_CheckedChanged"  />
