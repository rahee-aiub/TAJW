<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldSaleReturnUnfixed.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldSaleReturnUnfixed" Title="Gold Sale Return - Unfixed" %>
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table class="style1">
                        <thead>
                            <tr>
                                <th colspan="4">Un-Fix Gold Sale Return
                                </th>
                            </tr>
                    ...
                    <script type="text/javascript" src="../Script/chosen.jquery.js"></script>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:Label ID="Label3" runat="server" Text="Stock Out:" Width="92px" Font-Size="Large" ForeColor="Red"></asp:Label>
                                &nbsp;
                    ...
                    <h1>Gold Sale Return - Unfixed</h1>
                </td>
                <td style="vertical-align: top;">
                    <table class="style1">
                        <thead>
