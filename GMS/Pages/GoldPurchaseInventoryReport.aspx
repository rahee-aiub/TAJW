<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldPurchaseInventoryReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldPurchaseInventoryReport" Title="Gold Purchase Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        ...
        <table class="style1" width="800px">
            <thead>
                <tr>
                    <th colspan="6">Gold Purchase Report
                    </th>
                </tr>

            </thead>
            <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtPurchaseAndReturn" runat="server" GroupName="RptOptPrm" Text="Gold Purchase and Purchasee Return" Style="font-weight: 700" Font-Italic="True" Checked="True" AutoPostBack="true" OnCheckedChanged="rbtPurchaseAndReturn_CheckedChanged" />

                </td>
            </tr>

             <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtPurchaseFixing" runat="server" GroupName="RptOptPrm" Text="Gold Purchase Fixing" Style="font-weight: 700" Font-Italic="True" AutoPostBack="true" OnCheckedChanged="rbtPurchaseFixing_CheckedChanged" />
            ...
            <tr>
                <td></td>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtDetails" runat="server" GroupName="RptDtlOptPrm" Font-Size="Large" Text="Details" Style="font-weight: 700" Font-Italic="True"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RadioButton ID="rbtSummary" runat="server" GroupName="RptDtlOptPrm" Font-Size="Large" Text="Summary" Style="font-weight: 700" Font-Italic="True" Checked="true"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <%--<td>
                      <asp:TextBox ID="txtPartyCode" runat="server" Visible="false" Enabled="false" CssClass="cls text" Width="100px" Height="22px" BorderColor="#1293D1" BorderStyle="Ridge"
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label2" runat="server" Width="90px" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
