<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="SaleFixingReturn.aspx.cs" Inherits="ATOZWEBGMS.Pages.SaleFixingReturn" Title="Sale - Fixing Return" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="divMain" runat="server" align="center">
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table class="style1">
                        ...
                        <thead>
                            <tr>
                                <th colspan="4">Sale Fixing Return
                                </th>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGoldPureWt" runat="server" CssClass="cls text" Width="150px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Height="25px" Font-Size="Large" MaxLength="50" Style="text-align: Right" AutoPostBack="True" OnTextChanged="txtGoldPureWt_TextChanged"></asp:TextBox>
        ...
        <br />
        <table class="style1" style="width: 700px; height: 400px; background-color: #e9e9e9;">
            <tr>
                <td style="vertical-align: top;">
                    <table class="style1" style="width: 340px; height: 300px;">
                        <thead>
                            <tr>
                                <th colspan="4">
                                    <asp:Label ID="Label41" runat="server" Text="Sale Fixing" Font-Size="Large"
                ...
                <td style="vertical-align: top;">
                    <table class="style1" style="width: 340px; height: 300px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtConvRate" runat="server" CssClass="cls text" Width="150px" Height="27px" BorderColor="#1293D1" BorderStyle="Ridge"  onkeypress="return IsDecimalKey(event)"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtConvDiscount" runat="server" CssClass="cls text" Width="150px" Height="27px" BorderColor="#1293D1" BorderStyle="Ridge" onkeypress="return IsDecimalKey(event)"
