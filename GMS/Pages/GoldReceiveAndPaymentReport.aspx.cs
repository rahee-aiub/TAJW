...
{
    public partial class GoldReceiveAndPaymentReport : System.Web.UI.Page
    {
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptGoldReceiveAndPaymentReport");
