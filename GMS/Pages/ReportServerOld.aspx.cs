...
{
    public partial class ReportServerOld : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string notifyMsg = "?msg=" + ex.ToString() + System.Environment.NewLine + Request.UrlReferrer + "&PreviousMenu=ERPModule.aspx";
        ...
        protected void GenerateReport()
        {
            ...
            {                
                ...
                if ((reportFile != string.Empty) & (reportFile != null))
                {
                    ...
                    //ConfigurationManager.AppSettings["InitialDB"].Trim();
        ...
        //......................................Multiuser Store Procedure...........................
            ...
            {
                string notifyMsg = "?msg=" + ex.ToString() + System.Environment.NewLine + "Please Check Value = " + paramName + System.Environment.NewLine + Request.UrlReferrer + "&PreviousMenu=ERPModule.aspx";
                Server.Transfer("MessageDisplay.aspx" + notifyMsg);
