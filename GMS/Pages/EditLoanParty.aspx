<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="EditLoanParty.aspx.cs" Inherits="ATOZWEBGMS.Pages.EditLoanParty" Title="Edit Loan Party" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Edit Loan Party Code
                    </th>
                </tr>
                ...
                <td>
                    <asp:TextBox ID="txtLoanPartyCode" runat="server" CssClass="cls text" Width="100px" Height="25px" MaxLength="6" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" AutoPostBack="True" OnTextChanged="txtLoanPartyCode_TextChanged" ></asp:TextBox>
