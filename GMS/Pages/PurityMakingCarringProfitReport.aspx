<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="PurityMakingCarringProfitReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.PurityMakingCarringProfitReport" Title="Loss Profit Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        ...
        <table class="style1" width="800px">
            <thead>
                <tr>
                    <th colspan="6">Purity,Making,Carring Loss/Profit Report
                    </th>
                </tr>
