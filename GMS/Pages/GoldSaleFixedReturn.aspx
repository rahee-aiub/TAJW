<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldSaleFixedReturn.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldSaleFixedReturn" Title="Gold Sale - Fixed Return" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtConvRate" runat="server" CssClass="cls text" Width="150px" Height="27px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Font-Size="Large" Style="text-align: Right" AutoPostBack="True" OnTextChanged="txtConvRate_TextChanged1"></asp:TextBox>
                            </td>
