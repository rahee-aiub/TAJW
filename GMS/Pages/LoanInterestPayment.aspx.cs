...
{
    public partial class LoanInterestPayment : System.Web.UI.Page
    {
        ...
        protected void txtPartyCode_TextChanged(object sender, EventArgs e)
        {
            if (txtPartyCode.Text != string.Empty)
            {
                ...
                else
                {
                    ...
                    if (ddlLoanType.SelectedIndex != 0 && ddlCurrency.SelectedIndex != 0)
                    {
        ...
        protected void ClearRecords()
        {
            ...
            txtLoanIntAmount.Text = string.Empty;
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                prm[13] = txtLoanIntAmount.Text;
                prm[14] = txtInterestRate.Text;
                prm[15] = txtTranDesc.Text;


                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("Sp_UpdateLoanInterestPayment", prm, "A2ZACGMS"));
        ...
        protected void txtReInput_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtLoanIntAmount.Text == txtReInput.Text)
            {
            ...
            else
            {
                txtReInput.Text = string.Empty;
                txtLoanIntAmount.Text = string.Empty;
                txtLoanIntAmount.Focus();
            }
        }

        protected void txtLoanIntAmount_TextChanged(object sender, EventArgs e)
        {
            lblReInput.Text = "Please Re-Input Loan Interest Amount";
