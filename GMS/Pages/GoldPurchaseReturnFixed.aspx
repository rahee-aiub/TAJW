<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldPurchaseReturnFixed.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldPurchaseReturnFixed" Title="Gold Purchase Return - Fixed" %>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <table class="style1">
                            <thead>
                                <tr>
                                    <th colspan="4">Fixed - Gold Purchase Return
                                    </th>
                                </tr>
                    ...
                    <script type="text/javascript" src="../Script/chosen.jquery.js"></script>
                        ...
                        <%--<h1>Gold Purchase Return - Fixed</h1>--%>
                    </td>
                    <td style="vertical-align: top;">
                        <table class="style1">
                            <thead>
                ...
                <td style="vertical-align: top;">
                    <table class="style1" style="width: 340px; height: 380px;">
                        <thead>
                            <tr>
                                <th colspan="4">
                                    <asp:Label ID="Label41" runat="server" Text="Fixed - Purchase Return" Font-Size="Large"
