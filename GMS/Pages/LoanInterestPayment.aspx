<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="LoanInterestPayment.aspx.cs" Inherits="ATOZWEBGMS.Pages.LoanInterestPayment" Title="Interest Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="DivMain" runat="server" align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="4">Loan Interest Payment
                    </th>
                </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Ledger Balanace :" Width="180px" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label10" runat="server" Text="Currency :" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
        ...
        <table class="style1">
          ...
          <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="Loan Interest Amount :" Font-Size="Large" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtLoanIntAmount" runat="server" CssClass="cls text" Width="150px" Height="27px" Style="text-align: Right" BorderColor="#1293D1" BorderStyle="Ridge"
                        Font-Size="Large" TabIndex="6" autocomplete="off" AutoPostBack="true" OnTextChanged="txtLoanIntAmount_TextChanged" onkeyup="javascript:this.value=Comma(this.value);"></asp:TextBox>
                      &nbsp; &nbsp; &nbsp; 
                </td>
