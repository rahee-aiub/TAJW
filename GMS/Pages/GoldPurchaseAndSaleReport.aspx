<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldPurchaseAndSaleReport.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldPurchaseAndSaleReport" Title="Gold Purchase & Sale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        ...
        <table class="style1" width="800px">
            <thead>
                <tr>
                    <th colspan="6">Gold Purchase & Sale Report
                    </th>
                </tr>

            </thead>
           <%-- <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtPurchaseAndReturn" runat="server" GroupName="RptOptPrm" Text="Gold Purchase and Purchasee Return" Style="font-weight: 700" Font-Italic="True" Checked="True" />

                </td>
            </tr>

             <tr>
                <td colspan="8">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:RadioButton ID="rbtPurchaseFixing" runat="server" GroupName="RptOptPrm" Text="Gold Purchase Fixing" Style="font-weight: 700" Font-Italic="True" />
