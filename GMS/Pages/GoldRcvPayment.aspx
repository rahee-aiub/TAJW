<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="GoldRcvPayment.aspx.cs" Inherits="ATOZWEBGMS.Pages.GoldRcvPayment" Title="Gold Receive/Payment" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlLocation" runat="server" Height="30px" BorderColor="#1293D1" BorderStyle="Ridge"
                                    Width="250px" Font-Size="Large" Enabled="false">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnAdd" runat="server" Text="Add" Font-Size="Large" ForeColor="White"
                                    Font-Bold="True" ToolTip="Add Information" CssClass="button green"
                                    Height="27px" OnClick="btnAdd_Click" />
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <div align="center" class="grid_scroll">
                                    <asp:GridView ID="gvItemDetails" runat="server" HeaderStyle-BackColor="YellowGreen" Width="700px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PartyAccNo" HeaderText="PartyAccNo" />
