<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="EditInventoryLedgerControl.aspx.cs" Inherits="ATOZWEBGMS.Pages.EditInventoryLedgerControl  " Title="Edit Inventory Ledger Control" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">Edit Inventory Ledger Control
                    </th>
                </tr>
