<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true" CodeBehind="PartyAccountStatement.aspx.cs" Inherits="ATOZWEBGMS.Pages.PartyAccountStatement" %>
...
<%--                    <asp:Label ID="lblStat" runat="server" Text="Status :" Font-Size="Large" ForeColor="Red"></asp:Label>
                    <asp:TextBox ID="txtstat" runat="server" Text="" Font-Bold="true" Font-Size="Medium" ForeColor="Red" Enabled="false"></asp:TextBox>--%>
