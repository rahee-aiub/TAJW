...
{
    public partial class SaleFixing : System.Web.UI.Page
    {
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int result = Converter.GetInteger(CommonManager.Instance.GetScalarValueBySp("[Sp_SaleFixing]", prm, "A2ZACGMS"));
