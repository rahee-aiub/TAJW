...
{
    public partial class LoanPrincipalPayment : System.Web.UI.Page
    {
        ...
        private void PrintVoucher()
        {
            ...
            SessionStore.SaveToCustomStore(DataAccessLayer.Utility.Params.REPORT_FILE_NAME_KEY, "rptLoanPrincipalReturnVoucher");
        ...
        protected void txtReInput_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtPrincLoanAmount.Text == txtReInput.Text)
            {
            ...
            else
            {
                txtReInput.Text = string.Empty;
                txtPrincLoanAmount.Text = string.Empty;
                txtPrincLoanAmount.Focus();
            }
        }

        protected void txtPrincLoanAmount_TextChanged(object sender, EventArgs e)
        {
            lblReInput.Text = "Principal Loan Amount";
