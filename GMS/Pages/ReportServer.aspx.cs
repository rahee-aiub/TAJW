...
namespace ATOZWEBGMS.Pages
{
    public partial class ReportServer : System.Web.UI.Page
    {
        ...
        {
            string serverName = ConfigurationManager.AppSettings["DBServer"].Trim();
            ...
            {                
                ...
                if ((reportFile != string.Empty) & (reportFile != null))
                {
                    ...
                    conn.DatabaseName = Converter.GetString(SessionStore.GetValue(Params.REPORT_DATABASE_NAME_KEY));

                    //if (serverName == "myrdstest.ccdhwjdbgqq3.ap-south-1.rds.amazonaws.com")
                    //{
                    //    // =========== For Cloud System ===============
                    //    conn.ServerName = "myrdstest.ccdhwjdbgqq3.ap-south-1.rds.amazonaws.com";
                    //    conn.UserID = "masterUsername";
                    //    conn.Password = "masterUsername";
                    //    conn.IntegratedSecurity = false;
                    //    // =========== End of For Cloud System ==========
                    //}
                    //else
                    //{
                    ...
                    for (int i = 0; i <= parameterFieldsCount; i++)
                    {
                       ...
                       //Report Parameters Fields 34
                        ...
                        //else if (paramName == "@InopDate")
                        //{
                        //    pV.Value = SessionStore.GetValue(Params.INOP_DATE);
                        //    pList.Add((ParameterValue)pV);
                        //    theReport.DataDefinition.ParameterFields[paramName].ApplyCurrentValues(pList);
                        //}
                        ...
                        else if (paramName == "@GroupCode")
                        {
                            pV.Value = SessionStore.GetValue(Params.GROUPCODE);
                            pList.Add((ParameterValue)pV);
                            theReport.DataDefinition.ParameterFields[paramName].ApplyCurrentValues(pList);
                        }
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            string Fname = Server.MapPath("~/App_Data/" + Session.SessionID.ToString() + ".pdf");
