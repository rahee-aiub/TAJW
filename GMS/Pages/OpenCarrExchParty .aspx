<%@ Page Language="C#" MasterPageFile="~/MasterPages/CustomerServices.Master" AutoEventWireup="true"
    CodeBehind="OpenCarrExchParty .aspx.cs" Inherits="ATOZWEBGMS.Pages.OpenCarrExchParty  " Title="New Party Open" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center">
        <table class="style1">
            <thead>
                <tr>
                    <th colspan="3">New Carrier/Currency Exchange Party Code
                    </th>
                </tr>
